...
<form id="theform" method="post" action="<?= base_url() ?>/salereceivables/editprocess/" enctype="multipart/form-data"> 
<?= csrf_field(); ?>
<div class="row">
                <div class="col-sm-5">
                <div class="mb-4">
...
<?php
      ...
      ?>
<input type="hidden" id="paymentid" name="paymentid" value="<?=$sql->payment_id?>" >
