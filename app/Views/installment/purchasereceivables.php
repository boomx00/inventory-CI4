        ...
        $countttt = 0;
          ...
          ?>
            <tr onclick="button(0);anotherfunc(<?=$count?>);test(<?=$count?>)" value="0" id="tr<?=$count?>">    
                ...
                <td><?= $x->date ?></td>
                <td id="supplier<?=$count?>"><?= $x->supplier ?></td>
...
//     // document.getElementById("editamount").value = amount;
    ...
    document.getElementById('myframe').src ='http://localhost:8080/purchasereceivables/editpurchasereceivables/'+paymentid;
//     // alert();
...
function anotherfunc(x){
    ...
    var supplier = document.getElementById('supplier'+x).innerHTML;
    ...
    $.ajax({
  url : "<?php echo base_url("purchasereceivables/getdata"); ?>",
              type: "GET",
                data: dataJson, 
                dataType: "json",
              ...
              {
                //   alert(data.total);
                document.getElementById('named').innerHTML = data.supplier;
...
var dataJson = { 
          ...
          $.ajax({
  url : "<?php echo base_url("purchasereceivables/gettable"); ?>",
              type: "GET",
                data: dataJson, 
                dataType: "json",
              success: function(data)
...
function getdata(y,x){
    ...
    var dataJson = { 
          ...
          $.ajax({
  url : "<?php echo base_url("purchasereceivables/getdataiframe"); ?>",
              type: "GET",
                data: dataJson, 
                dataType: "json",
              success: function(data)
