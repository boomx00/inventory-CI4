  ...
  <!-- <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css"> -->
    ...
    <main class="flex-shrink-0">
        <div class="stockCreateContainer">
            ...
            <?php endif; ?>
            <form method="post" enctype="multipart/form-data" action="<?= base_url(); ?>/supplier/editprocess/ <?=$id?>">
             <?= csrf_field(); ?>
                <div class="row">
        <div class="col-sm-6">
            <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                <pre><textarea class="form-control" style="white-space: pre-wrap;" rows="5" id="comment" name="comment"><?=$supplier->detail?></textarea></pre>                </div>
            </div>
