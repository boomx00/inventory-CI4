            ...
            <thead>
              ...
              ?>
                  <tr>
                      ...
                      <td><?= $row->phone; ?></td>
                      <td>
                        <a href="#" class="btn btn-info btn-sm click" data-id="<?= $row->id ?>" data-name="<?= $row->name?>" data-address="<?= $row->address?>" data-phone="<?= $row->phone?>">Edit</a>
                          <a title="Delete" href="<?= base_url("customer/delete/$row->id") ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus data ?')">Delete</a>
                      </td>
                  </tr>
              <?php
              }
...
<!-- MODAL TO EDIT DATA -->
<form name="formm" action="<?= base_url('/customer/updatedata/')?>" onsubmit="return validateForm()" required>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Change Customer Data</h5>
...
<!-- MODAL TO CREATE DATA -->
<form name="formm" action="<?= base_url('/customer/create/')?>" onsubmit="return validateForm()" required>
...
$(".setupdate").on("click",function(){
  ...
  var phone = document.forms["formm"]['phone'].value;
  if(name == '' || phone == ''){
    alert ('Name and Phone Numbers cannot be empty');
    return false;
  }
})
